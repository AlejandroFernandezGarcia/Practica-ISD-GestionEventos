...
public class XmlResponseDtoConversor {
	...
	public static XmlEntityResponseWriter toResponse(ResponseDto responseDto) {
		Element responseElement = toXml(responseDto);
	...
	public static Element toXml(ResponseDto responseDto) {
