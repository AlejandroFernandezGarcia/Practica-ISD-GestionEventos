...
public class SoapEventService {
	...
	public Long addEvent(@WebParam(name = "eventDto") EventDto eventDto)
		...
		try {
			return EventServiceFactory.getService().addEvent(event)
					.getEventId();
	...
	public void updateEvent(@WebParam(name = "eventDto") EventDto eventDto)
			...
			SoapEventRegisteredUsersException {
		Event event = EventToEventDtoConversor.toEvent(eventDto);
		try {
	...
	@WebMethod(operationName = "findEventByKeyword")
	public List<EventDto> findEventByKeyword(
			@WebParam(name = "clave") String clave,
			@WebParam(name = "dateSt") Calendar dateSt,
			@WebParam(name = "dateEnd") Calendar dateEnd) {

		List<Event> eventList = EventServiceFactory.getService()
				.findEventByKeyword(clave, dateSt, dateEnd);
		return EventToEventDtoConversor.toEventDtos(eventList);
	}

	@WebMethod(operationName = "responseToEvent")
	public Long responseToEvent(@WebParam(name = "username") String username,
	...
	@WebMethod(operationName = "getResponses")
	public List<ResponseDto> getResponses(
			@WebParam(name = "eventId") Long eventId,
			@WebParam(name = "code") Boolean code)
			throws SoapInstanceNotFoundException {
		try {
			List<Response> responsesList = EventServiceFactory.getService()
	...
	@WebMethod(operationName = "getResponsesByID")
	public ResponseDto getResponsesByID(
			@WebParam(name = "responseId") Long responseId)
			throws SoapInstanceNotFoundException {
		try {
			Response response = EventServiceFactory.getService()
