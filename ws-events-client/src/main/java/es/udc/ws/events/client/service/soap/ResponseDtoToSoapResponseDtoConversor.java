...
public class ResponseDtoToSoapResponseDtoConversor {
	public static es.udc.ws.events.client.service.soap.wsdl.ResponseDto toSoapResponseDto(
			ResponseDto response) {
		es.udc.ws.events.client.service.soap.wsdl.ResponseDto soapResponseDto = new es.udc.ws.events.client.service.soap.wsdl.ResponseDto();
	...
	public static List<ResponseDto> toResponseDtos(
		...
		for (int i = 0; i < responses.size(); i++) {
			es.udc.ws.events.client.service.soap.wsdl.ResponseDto response = responses
					.get(i);
